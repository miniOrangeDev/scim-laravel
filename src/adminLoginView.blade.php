...
<section class="login-content">
    <div class="logo">
        <h1>
            <img src="miniorange/mo_scim_free/resources/images/logo_large.png">
        </h1>
    </div>
    <div class="col-md-5">
        <div class="tile">
            ...
            <form class="login_form" method="POST" action="">
                ...
                <div class="tile-footer">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-3">
                            ...
                            <button type="button" name="mo_scim_goback" id="goto_register" class="btn btn-primary">
                ...
                <script>
                        document.getElementById("goto_register").onclick = function(){
                            window.location.href = "mo_scim_register.php";
                        }
                        <?php
                            if(mo_scim_is_user_registered()){
                                ?>
...
<script src="miniorange/mo_scim_free/includes/js/jquery-3.2.1.min.js"></script>
<script src="miniorange/mo_scim_free/includes/js/popper.min.js"></script>
<script src="miniorange/mo_scim_free/includes/js/bootstrap.min.js"></script>
<script src="miniorange/mo_scim_free/includes/js/main.js"></script>
<!-- The javascript plugin to display page loading on top-->
<script src="miniorange/mo_scim_free/includes/js/plugins/pace.min.js"></script>
<script type="text/javascript"
        src="miniorange/mo_scim_free/includes/js/plugins/bootstrap-notify.min.js"></script>
<script type="text/javascript"
        src="miniorange/mo_scim_free/includes/js/plugins/sweetalert.min.js"></script>
<?php
