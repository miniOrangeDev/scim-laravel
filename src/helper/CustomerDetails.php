...
class CustomerDetails
{
    ...
    {
        try {
            $result = LaraDB::select('select * from mo_scim_customer_details where mo_scim_domain_name = ?', [self::oauth_get_current_domain()]);
            if( count($result) == 0 ) {
    ...
    {
        try {
            $result = LaraDB::table('mo_scim_customer_details')->updateOrInsert([
