                    ...
                    <div class="col-lg-12">
                        <form method="post" action="">
                            ...
                            <input type="hidden" name="option"
                                   value="mo_scim_trial_request_option"/>
                            <div class="form-group">
                                <label style="font-size: 1.25rem;" for="mo_scim_trial_request_email">Email: </label>
                                <input class="form-control" type="email"
                                       id="mo_scim_trial_request_email"
                                       name="mo_scim_trial_request_email" placeholder="Enter your email"
                                       required
                                       value="<?php echo CD::get_option('mo_scim_admin_email');?>">
                            </div>
                            <div class="form-group">
                            <label style="font-size: 1.25rem;" for="mo_scim_trial_request_use_case">Enter you usecase: </label>
								<textarea class="form-control"
                                          id="mo_scim_trial_request_use_case"
                                          name="mo_scim_trial_request_use_case"
